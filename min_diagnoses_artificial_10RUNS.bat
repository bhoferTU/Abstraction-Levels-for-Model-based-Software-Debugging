...
set CONFIG_FILE6=min_diagnoses_artificial_RUN6.config
set CONFIG_FILE7=min_diagnoses_artificial_RUN7.config
set CONFIG_FILE8=min_diagnoses_artificial_RUN8.config
set CONFIG_FILE9=min_diagnoses_artificial_RUN9.config
set CONFIG_FILE10=min_diagnoses_artificial_RUN10.config
